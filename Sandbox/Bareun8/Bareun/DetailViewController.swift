...
//    let pencilInteraction = UIPencilInteraction()
    ...
    override func viewDidLoad() {
        ...
        let ratio = bounds.width / textImage.size.width
        self.canvasView.minimumZoomScale = ratio
//        self.canvasView.zoomScale = 0.3
        ...
        self.underlayView.frame = CGRect(origin: CGPoint.zero, size: backgroundImage.size * ratio)
        ...
        self.overlayView.frame = CGRect(origin: CGPoint.zero, size: textImage.size * ratio)
